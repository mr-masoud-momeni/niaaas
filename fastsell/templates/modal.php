...
/**
 * EasySale Modal Template — redesigned
 * Visual language imported from Claude Design ("Modal خرید سریع").
 * All class names / IDs / data-attributes are preserved so easysale.js and the
 * AJAX fragment renderers keep working unchanged.
 */
...
<?php
// data-lenis-prevent: قالب‌هایی که اسکرول نرم (Lenis / Locomotive) دارند رویداد
// wheel را روی window می‌گیرند و صفحه را خودشان حرکت می‌دهند؛ این صفت به آن‌ها
// می‌گوید رویدادهای داخل مودال را دست نزنند تا اسکرول بومی مودال کار کند.
?>
<div id="nias-login-fastsell-modal" class="nias-login-fastsell-modal" dir="rtl" data-lenis-prevent>
    <div class="nias-login-fastsell-modal-overlay"></div>

    <div class="nias-login-fastsell-modal-content">
        <button type="button" class="nias-login-fastsell-modal-close" aria-label="<?php esc_attr_e('بستن', 'nias-login-signup'); ?>">
